                ...
                when (numCompositionsSinceTimeout) {
                    ...
                    // color from yellow to red, and continually increase the border size.
                        ...
                        lerp(
                            ...
                            fraction = min(
                                MinFraction,
                                (numCompositionsSinceTimeout - 1).toFloat() / InterpolationDivisor
                            )
...
private object RecomposeHighlighter {
    const val DrawTimeout = 3000L
    const val MinFraction = 1f
    const val InterpolationDivisor = 100f
}
